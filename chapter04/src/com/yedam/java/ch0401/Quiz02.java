...
public class Quiz02 {
	...
	public static void main(String[] args) {
		...
		switch(num) {
		case 1:
			System.out.println("%d X 6 = %d", 1, 1*6);
			break;
		case 2:
			System.out.println("%d X 6 = %d", 2, 2*6);
			break;
		case 3:
			System.out.println("%d X 6 = %d", 3, 3*6);
			break;
		case 4:
			System.out.println("%d X 6 = %d", 4, 4*6);
			break;
		case 5:
			System.out.println("%d X 6 = %d", 5, 5*6);
			break;
		case 6:
			System.out.println("%d X 6 = %d", 6, 6*6);
			break;
