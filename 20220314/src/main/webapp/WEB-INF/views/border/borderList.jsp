		...
		<div>
			...
			<div>
				<table border="1">
					<thead>
						<tr>
							<th width="70"><span style="color:red" onclick="sortBorder('A')">A </span>번호
					...
					<tbody id="borderBody">
						...
						<c:if test="${not empty borders }">
							...
							<tr onmouseover='this.style.background="#fcecae";' 
								...
								<td align="center">${b.borderTitle }</td>
			 ...
			 <div>
			 	<button type="button" onclick="location.href='borderInsertForm.do'">게시글 작성</button>
			 </div>
...
<script type="text/javascript">
	...
	function searchResult(data) { //json 객체를 html로 변환 후 화면에 적용함
		...
		$.each(data, function(index, item) { 
			...
			$("<td align='center'/>").text(item.borderTitle),
			$("<td />").text(item.borderWriter),
